...
public final class USBMonitor {
     ...
     */
    private static final int CHECK_DEVICE_RUNNABLE_DELAY = 300;

    private static final String ACTION_USB_PERMISSION_BASE = "com.libuvccamera.USB_PERMISSION.";
    ...
    public synchronized void register() throws IllegalStateException {
        ...
        if (mPermissionIntent == null) {
            ...
            if (context != null) {
                ...
                context.registerReceiver(mUsbReceiver, filter, ACTION_USB_PERMISSION, mAsyncHandler);
            }
...
//			if (DEBUG) Log.i(TAG, "unregister:");
    ...
    public static class UsbControlBlock implements Cloneable {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(mWeakMonitor, mWeakDevice, mConnection, mInfo, mBusNum, mDevNum, mInterfaces);
        }
