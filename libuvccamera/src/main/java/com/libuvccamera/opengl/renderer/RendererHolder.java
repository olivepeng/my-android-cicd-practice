package com.libuvccamera.opengl.renderer;

import static com.libuvccamera.opengl.ShaderConst.GL_TEXTURE_EXTERNAL_OES;
...
import com.libuvccamera.opengl.EGLBase;
import com.libuvccamera.opengl.EGLTask;
import com.libuvccamera.opengl.GLDrawer2D;
import com.libuvccamera.opengl.GLHelper;
...
public class RendererHolder extends EGLTask implements IRendererHolder {
    ...
    private static final int REQUEST_FPS = 20;
...
//                }
        ...
        private void emitFrameRate() {
            mFrameRate++;
            mEndTime = System.currentTimeMillis();
            if (mEndTime - mStartTime >= 1000) {
                if (DEBUG) {
                    Log.i(TAG, "camera render frame rate is " + mFrameRate + " fps");
                }
                sendEmptyMessage(REQUEST_FPS);
                mStartTime = mEndTime;
                mFrameRate = 0;
            }
        }
