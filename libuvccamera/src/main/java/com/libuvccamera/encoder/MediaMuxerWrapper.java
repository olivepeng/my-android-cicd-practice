...
package com.libuvccamera.encoder;
...
public class MediaMuxerWrapper {
    ...
    public MediaMuxerWrapper(Uri uri) throws IOException {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            ...
            try {
                parcelFileDescriptor = context.getContentResolver().openFileDescriptor(mOutputUri, "rw");
                final FileDescriptor fileDescriptor = parcelFileDescriptor.getFileDescriptor();
                mMediaMuxer = new MediaMuxer(fileDescriptor, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
            }finally {
