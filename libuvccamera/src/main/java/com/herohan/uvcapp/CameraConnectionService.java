...
import com.libuvccamera.usb.DeviceFilter;
...
import com.libuvccamera.usb.USBMonitor;
import com.libuvccamera.usb.USBMonitor.OnDeviceConnectListener;
import com.libuvccamera.usb.USBMonitor.UsbControlBlock;
...
import com.libuvccamera.uvccamera.R;
...
class CameraConnectionService {
    ...
    private static CameraConnectionService mInstance;

    CameraConnectionService() {
    }

    public static synchronized CameraConnectionService getInstance() {
        if (mInstance == null) {
    ...
    private final class CameraConnection implements ICameraConnection {
        ...
        @Override
        public void takePicture(UsbDevice device,
            ...
            final CameraInternal cameraInternal = getCamera(device);
            if (cameraInternal != null) {
                cameraInternal.takePicture(zoom, options, callback);
            }
        }
