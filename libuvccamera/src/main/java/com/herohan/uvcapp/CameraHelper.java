...
//                        mCallbackWrapper.onCameraClose(mUsbDevice);
    ...
    public void takePicture(
        ...
        mAsyncHandler.post(() -> {
            if (mService != null && mUsbDevice != null) {
                try {
                    mService.takePicture(mUsbDevice,zoom, options, callback);
                } catch (final Exception e) {
